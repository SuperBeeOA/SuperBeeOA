...
public class CharacterEncodingFilter implements Filter {
	...
	public void doFilter(ServletRequest req, ServletResponse res, FilterChain fc)
		 ...
		 * request.setCharacterEncoding(encoding); else request = new
		 * HttpRequestWrapper(request); fc.doFilter(request, res);
		 */
	}
	...
	public void init(FilterConfig fg) throws ServletException {
		...
		if (this.encoding == null || "".equals(encoding))
			this.encoding = "UTF-8";
	}
	...
	public class HttpRequestWrapper extends HttpServletRequestWrapper {
		...
		public String getParameter(String name) {
			String value = null;
			value = this.encoding(((HttpServletRequest) this.getRequest())
					.getParameter(name));
		...
		public String[] getParameterValues(String name) {
			String[] values = ((HttpServletRequest) this.getRequest())
